...
public class pnlProductos extends JPanel {
    ...
    public pnlProductos() {
        ...
        lbProducto1.setIcon(new ImageIcon(pnlProductos.class
        ...
        lblBebida1.setIcon(new ImageIcon(pnlProductos.class
        ...
        lblPostre1.setIcon(new ImageIcon(pnlProductos.class
