...
public class pnlClientes extends JPanel {
    ...
    public pnlClientes() {
        ...
        lblHelp.setIcon(new ImageIcon(pnlClientes.class
        ...
        btnAadirCliente.setIcon(new ImageIcon(pnlClientes.class
        ...
        btnEditarCliente.setIcon(new ImageIcon(pnlClientes.class
        ...
        btnBorrarCliente.setIcon(new ImageIcon(pnlClientes.class.getResource(
